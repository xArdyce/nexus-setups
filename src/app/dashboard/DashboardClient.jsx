...
export default function CreatorDashboard({ user }) {
    ...
    const analyticsData = {
        all: {
            ...
            revenue: "R48,920",
            graphTitle:
                "VIEWERSHIP TRAJECTORY (PAST 6 WEEKS)",
            distTitle:
                "DELIVERABLE FORMAT DISTRIBUTION",
            topTitle:
                "TOP PERFORMING CONTENT (LAST 7D)",

            svgArea:
                "M 0 150 Q 120 110, 240 120 T 480 45 L 600 25 L 600 200 L 0 200 Z",

            svgLine:
                "M 0 150 Q 120 110, 240 120 T 480 45 L 600 25",
            ...
            topContent: [
                {
                    ...
                    class: "yt",
                    title:
                        "PC Desk Setup Tour — 240Hz AM5 Upgrade",
                    sub:
                        "142,000 views • 94% VBR • 11:20 watch time",
                    stat: "+14.2K subs",
                },
                {
                    badge: "TT",
                    class: "tt",
                    title:
                        "CoD Bo7 Camo Grind Movement Guide",
                    sub:
                        "890,000 views • 82% completion rate",
                    stat: "+28.4K subs",
                },
                {
                    badge: "X",
                    class: "tw",
                    title:
                        "Futives Controller Settings Config Thread",
                    sub:
                        "45,200 impressions • 3,400 engagements",
                    stat: "9.2% ER",
                },
            ],
        },
        ...
        youtube: {
            ...
            revenue: "R38,400",
            graphTitle:
                "YOUTUBE VIEWS & WATCH TIME TRAJECTORY",
            distTitle: "YOUTUBE FORMAT BREAKDOWN",
            topTitle: "TOP YOUTUBE VIDEOS",

            svgArea:
                "M 0 170 Q 150 90, 300 100 T 500 35 L 600 20 L 600 200 L 0 200 Z",

            svgLine:
                "M 0 170 Q 150 90, 300 100 T 500 35 L 600 20",
            ...
            topContent: [
                ...
                },
                {
                    ...
                    class: "yt",
                    title:
                        "AM5 Motherboard BIOS Tuning Guide",
                    sub:
                        "98,000 views • 88% VBR • 8:40 watch time",
                    stat: "+4,200 subs",
                },
            ],
        },
        ...
        tiktok: {
            ...
            revenue: "R7,520",
            graphTitle:
                "TIKTOK REELS ENGAGEMENT SURGE",
            distTitle: "TIKTOK CONTENT STYLES",
            topTitle: "TOP TIKTOK SHORTS",

            svgArea:
                "M 0 180 Q 100 60, 250 80 T 450 30 L 600 15 L 600 200 L 0 200 Z",

            svgLine:
                "M 0 180 Q 100 60, 250 80 T 450 30 L 600 15",

            distribution: [
                {
                    label: "Gameplay Montages",
                    pct: "65%",
                    color: "var(--purple-bright)",
                },
                {
                    label: "Setup Showcase",
                    pct: "35%",
                    color: "var(--green)",
                },
            ],
            ...
            topContent: [
                ...
                },
                {
                    ...
                    class: "tt",
                    title:
                        "Reverse Fan Airflow Setup Test",
                    sub:
                        "210,000 views • 91% completion rate",
                    stat: "+6,100 subs",
                },
            ],
        },
        ...
        twitter: {
            ...
            revenue: "R3,000",
            graphTitle:
                "X / TWITTER THREAD IMPRESSIONS",
            distTitle: "X MEDIA FORMATS",
            topTitle: "TOP X THREADS & CLIPS",

            svgArea:
                "M 0 160 Q 120 140, 240 130 T 480 90 L 600 70 L 600 200 L 0 200 Z",

            svgLine:
                "M 0 160 Q 120 140, 240 130 T 480 90 L 600 70",

            distribution: [
                {
                    label: "Config Threads",
                    pct: "70%",
                    color: "var(--blue)",
                },
                {
                    label: "Direct Video Clips",
                    pct: "30%",
                    color: "var(--yellow)",
                },
            ],
            ...
            topContent: [
                ...
                },
                {
                    ...
                    class: "tw",
                    title:
                        "PKHeX Legality Checker Snippet",
                    sub:
                        "18,400 impressions • 1,200 engagements",
                    stat: "6.4% ER",
                },
            ],
        },
                            ...
                            <section className="analytics-graphs-grid">
                                ...
                                <div className="panel graph-panel">
                                    ...
                                    <div className="bar-chart-container">
                                        {activeAnalytics.distribution.map(
                                            (
                                                item,
                                                idx
                                            ) => (
                            ...
                            <section className="social-hub-grid">
                                <div className="panel">
                                    ...
                                    <div className="top-content-list">
                                        {activeAnalytics.topContent.map(
                                            (
                                                c,
                                                idx
                                            ) => (
                                                ...
                                                >
                                                    <span
                                                        className={`platform-badge ${c.class}`}
                                                    >
                                                        {
                                                            c.badge
                                                        }
                                ...
                                >
                                    ...
                                    <div className="form-field">
                                        ...
                                        <input
                                            ...
                                            id="stgPlan"
                                            className="dash-input"
                                            defaultValue="GROWTH PLAN — R17,999/mo"
                                            disabled
                                        />
                                    </div>
